...
rocThrustCI:
{
    ...
    def nodes = new dockerNodes(['ubuntu && gfx803', 'sles && gfx906', 'gfx900 && centos7', 'gfx906 && centos7'], rocthrust)
	...
	def command = """#!/usr/bin/env bash
                    ...
                    make -j4
                    ${sudo} ctest LD_LIBRARY_PATH=/opt/rocm/hcc/lib --output-on-failure
                """
