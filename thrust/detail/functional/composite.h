...
public:
  ...
  THRUST_HOST_DEVICE composite(const Eval0& e0, const Eval1& e1)
      : m_eval0(e0)
      , m_eval1(e1)
  {}

  template <typename Env>
  THRUST_HOST_DEVICE typename result<Env>::type eval(const Env& x) const
  {
...
public:
  ...
  THRUST_HOST_DEVICE composite(const Eval0& e0, const Eval1& e1, const Eval2& e2)
      : m_eval0(e0)
      , m_eval1(e1)
      , m_eval2(e2)
  {}
...
template <typename Eval0, typename Eval1>
THRUST_HOST_DEVICE actor<composite<Eval0, Eval1>> compose(const Eval0& e0, const Eval1& e1)
{
  return actor<composite<Eval0, Eval1>>(composite<Eval0, Eval1>(e0, e1));
}

template <typename Eval0, typename Eval1, typename Eval2>
THRUST_HOST_DEVICE actor<composite<Eval0, Eval1, Eval2>> compose(const Eval0& e0, const Eval1& e1, const Eval2& e2)
{
