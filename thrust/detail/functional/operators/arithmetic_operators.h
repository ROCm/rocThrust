...
THRUST_HOST_DEVICE actor<composite<transparent_unary_operator<thrust::negate<>>, actor<Eval>>> THRUST_HOST_DEVICE
...
template <typename Eval>
THRUST_HOST_DEVICE actor<composite<transparent_unary_operator<unary_plus>, actor<Eval>>> operator+(const actor<Eval>& _1)
{
  return compose(transparent_unary_operator<unary_plus>(), _1);
} // end operator+()

template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::plus<>>, actor<T1>, typename as_actor<T2>::type>>
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::plus<>>, typename as_actor<T1>::type, actor<T2>>>
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::plus<>>, actor<T1>, actor<T2>>>
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::minus<>>, typename as_actor<T1>::type, actor<T2>>>
operator-(const T1& _1, const actor<T2>& _2)
{
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::minus<>>, actor<T1>, typename as_actor<T2>::type>>
operator-(const actor<T1>& _1, const T2& _2)
{
  return compose(transparent_binary_operator<thrust::minus<>>(), make_actor(_1), make_actor(_2));
} // end operator-()
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::minus<>>, actor<T1>, actor<T2>>>
operator-(const actor<T1>& _1, const actor<T2>& _2)
{
  return compose(transparent_binary_operator<thrust::minus<>>(), make_actor(_1), make_actor(_2));
} // end operator-()
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::multiplies<>>, actor<T1>, actor<T2>>>
operator*(const actor<T1>& _1, const actor<T2>& _2)
{
  return compose(transparent_binary_operator<thrust::multiplies<>>(), make_actor(_1), make_actor(_2));
} // end operator*()
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::divides<>>, actor<T1>, actor<T2>>>
operator/(const actor<T1>& _1, const actor<T2>& _2)
{
  return compose(transparent_binary_operator<thrust::divides<>>(), make_actor(_1), make_actor(_2));
} // end operator/()
...
template <typename T1, typename T2>
THRUST_HOST_DEVICE actor<composite<transparent_binary_operator<thrust::modulus<>>, actor<T1>, actor<T2>>>
operator%(const actor<T1>& _1, const actor<T2>& _2)
{
  return compose(transparent_binary_operator<thrust::modulus<>>(), make_actor(_1), make_actor(_2));
} // end operator%()
...
template <typename Eval>
THRUST_HOST_DEVICE actor<composite<transparent_unary_operator<prefix_increment>, actor<Eval>>>
operator++(const actor<Eval>& _1)
{
...
template <typename Eval>
THRUST_HOST_DEVICE actor<composite<transparent_unary_operator<postfix_increment>, actor<Eval>>>
...
template <typename Eval>
THRUST_HOST_DEVICE actor<composite<transparent_unary_operator<prefix_decrement>, actor<Eval>>>
operator--(const actor<Eval>& _1)
{
...
template <typename Eval>
THRUST_HOST_DEVICE actor<composite<transparent_unary_operator<postfix_decrement>, actor<Eval>>>
operator--(const actor<Eval>& _1, int)
{
