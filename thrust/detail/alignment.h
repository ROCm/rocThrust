...
/// It is an implementation of C++11's \p std::alignment_of.
        ...
        {
            static const std::size_t value = integral_constant<std::size_t, size_diff>::value;
        };
...
#if __cplusplus >= 201103L && (THRUST_HOST_COMPILER == THRUST_HOST_COMPILER_GCC) \
    ...
    || ((THRUST_HOST_COMPILER == THRUST_HOST_COMPILER_GCC) && (THRUST_GCC_VERSION < 40300))
