...
#define __THRUST_DEFINE_HAS_MEMBER_FUNCTION(trait_name, member_function_name)                             \
    ...
    {                                                                                                     \
        ...
        template <typename U>                                                                             \
        static no                                                                                         \
                   deduce(U*, helper<Result (base_mixin::*)(Arg1, Arg2), &U::member_function_name>* = 0); \
        static yes deduce(...);                                                                           \
                                                                                                          \
    public:                                                                                               \
        static const bool value = sizeof(yes) == sizeof(deduce(static_cast<base*>(0)));                   \
    ...
    {                                                                                                     \
        ...
        template <typename U>                                                                             \
        static no deduce(                                                                                 \
            U*, helper<Result (base_mixin::*)(Arg1, Arg2, Arg3), &U::member_function_name>* = 0);         \
        static yes deduce(...);                                                                           \
                                                                                                          \
    public:                                                                                               \
        static const bool value = sizeof(yes) == sizeof(deduce(static_cast<base*>(0)));                   \
    ...
    {                                                                                                     \
        ...
        template <typename U>                                                                             \
        static no  deduce(U*,                                                                             \
                          helper<Result (base_mixin::*)(Arg1, Arg2, Arg3, Arg4),                          \
                                &U::member_function_name>* = 0);                                         \
        static yes deduce(...);                                                                           \
                                                                                                          \
    public:                                                                                               \
        static const bool value = sizeof(yes) == sizeof(deduce(static_cast<base*>(0)));                   \
