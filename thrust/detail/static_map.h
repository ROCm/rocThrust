    ...
    namespace detail
    {
        namespace static_map_detail
        {
            ...
            struct cons
            {
                ...
                struct static_get
                {
                    static const unsigned int value
                        = (key == Head::key) ? (Head::value)
                                             : Tail::template static_get<key, default_value>::value;
                };

                template <unsigned int default_value>
                __host__ __device__ static unsigned int get(unsigned int key)
                {
                    return (key == Head::key) ? (Head::value)
                                              : Tail::template get<default_value>(key);
                }
            };
            ...
            struct cons<Head, void>
            {
                ...
                {
                    static const unsigned int value
                        = (key == Head::key) ? (Head::value) : default_value;
                };
            ...
            struct static_map
            {
                                       ...
                                       cons<key_value<key3, value3>,
                                            cons<key_value<key4, value4>,
                                                 cons<key_value<key5, value5>,
                                                      cons<key_value<key6, value6>,
                                                           cons<key_value<key7, value7>>>>>>>>>
                    impl;
                ...
                {
                    static const unsigned int value
                        = impl::template static_get<key, default_value>::value;
                };
        ...
        template <unsigned int default_value,
                  ...
                  unsigned int key7   = 0,
                  unsigned int value7 = default_value>
        struct static_map : static_map_detail::static_map<default_value,
                                                          key0,
                                                          value0,
                                                          key1,
                                                          value1,
        ...
        __host__ __device__ unsigned int lookup(unsigned int key)
        {
