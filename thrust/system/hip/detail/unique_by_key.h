...
namespace hip_rocprim
{
                                               ...
                                               BinaryPred                 binary_pred)
    {
        ...
        THRUST_HIP_PRESERVE_KERNELS_WORKAROUND((__unique_by_key::unique_by_key<Derived,
                                                                               KeyInputIt,
                                                                               ValInputIt,
                                                                               KeyOutputIt,
                                                                               ValOutputIt,
    ...
    pair<KeyInputIt, ValInputIt>
        THRUST_HIP_FUNCTION unique_by_key(execution_policy<Derived>& policy,
                                          KeyInputIt                 keys_first,
                                          KeyInputIt                 keys_last,
                                          ValInputIt                 values_first,
                                          BinaryPred                 binary_pred)
    {
        ...
        THRUST_HIP_PRESERVE_KERNELS_WORKAROUND(
            (hip_rocprim::
                 unique_by_key_copy<Derived, KeyInputIt, ValInputIt, KeyInputIt, ValInputIt>));
#if __THRUST_HAS_HIPRT__
