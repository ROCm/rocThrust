...
struct iterator_traits<thrust::pointer<
  ...
  Tag,
  Reference,
  thrust::system::hip::detail::managed_memory_pointer<Element> > > {
private:
...
/*! A version of thrust::hip_rocprim::pointer that uses c++ references instead
 * of thrust::hip::reference. This is to allow managed memory pointers to
...
class managed_memory_pointer
    : public thrust::pointer<
        ...
        thrust::system::hip::detail::managed_memory_pointer<T> >
{
private:
  typedef thrust::pointer<
    T,
...
public:
   ...
   * in memory accessible by the \p hip system. \tparam OtherT \p OtherT
   ...
   * shall be convertible to \p thrust::system::hip::tag and its element
