...
namespace cuda_cub
{
    ...
    template <typename T>
    class reference
        : public thrust::reference<T, thrust::cuda_cub::pointer<T>, thrust::cuda_cub::reference<T>>
    {

    private:
        typedef thrust::reference<T, thrust::cuda_cub::pointer<T>, thrust::cuda_cub::reference<T>>
            super_t;
