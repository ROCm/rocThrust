            ...
            namespace detail
            {
                namespace reduce_intervals_detail
                {
                    ...
                    struct body
                    {
                        ...
                        body(RandomAccessIterator1 first,
                             RandomAccessIterator2 result,
                             Size                  n,
                             Size                  interval_size,
                             BinaryFunction        binary_op)
                        ...
                        void operator()(const ::tbb::blocked_range<Size>& r) const
                        {
                            ...
                            result[interval_idx]
                                = thrust::reduce(thrust::seq,
                                                 my_first + 1,
                                                 my_last,
                                                 sum_type(thrust::raw_reference_cast(*my_first)),
                                                 binary_op);
                        }
                    };
                    ...
                    body<RandomAccessIterator1, RandomAccessIterator2, Size, BinaryFunction>
                        make_body(RandomAccessIterator1 first,
                                  RandomAccessIterator2 result,
                                  Size                  n,
                                  Size                  interval_size,
                                  BinaryFunction        binary_op)
                    {
                        return body<RandomAccessIterator1,
                                    RandomAccessIterator2,
                                    Size,
                                    BinaryFunction>(first, result, n, interval_size, binary_op);
                    }
                ...
                void reduce_intervals(thrust::tbb::execution_policy<DerivedPolicy>&,
                                      ...
                                      BinaryFunction        binary_op)
                {
                    typename thrust::iterator_difference<RandomAccessIterator1>::type n
                        = last - first;
                    ...
                    ::tbb::parallel_for(::tbb::blocked_range<Size>(0, num_intervals, 1),
                                        reduce_intervals_detail::make_body(
                                            first, result, Size(n), interval_size, binary_op),
