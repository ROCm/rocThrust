        ...
        namespace detail
        {
            namespace generic
            {
                ...
                __host__ __device__ ForwardIterator
                                    stable_partition(thrust::execution_policy<ExecutionPolicy>& exec,
                ...
                template <typename ExecutionPolicy, typename ForwardIterator, typename Predicate>
                __host__ __device__ ForwardIterator
                                    partition(thrust::execution_policy<ExecutionPolicy>& exec,
                                              ForwardIterator                            first,
                                              ForwardIterator                            last,
                                              Predicate                                  pred);
                ...
                template <typename ExecutionPolicy, typename ForwardIterator, typename Predicate>
                __host__ __device__ ForwardIterator
                                    partition_point(thrust::execution_policy<ExecutionPolicy>& exec,
                                                    ForwardIterator                            first,
                                                    ForwardIterator                            last,
                                                    Predicate                                  pred);
                ...
                __host__ __device__ bool
                         is_partitioned(thrust::execution_policy<ExecutionPolicy>& exec,
                                        InputIterator                              first,
                                        InputIterator                              last,
                                        Predicate                                  pred);
