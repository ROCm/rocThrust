    ...
    namespace system
    {
        namespace detail
        {
                ...
                namespace select_system_exists_ns
                {
                    ...
                    struct select_system2_exists
                    {
                        ...
                        static const bool value
                            = sizeof(check(select_system(tag1, tag2))) == sizeof(yes);
                    };
                    ...
                    struct select_system3_exists
                    {
                        ...
                        static const bool value
                            = sizeof(check(select_system(tag1, tag2, tag3))) == sizeof(yes);
                    };
                    ...
                    struct select_system4_exists
                    {
                        ...
                        static const bool value
                            = sizeof(check(select_system(tag1, tag2, tag3, tag4))) == sizeof(yes);
                    };
                    ...
                    struct select_system5_exists
                    {
                        ...
                        static const bool value
                            = sizeof(check(select_system(tag1, tag2, tag3, tag4, tag5)))
                              == sizeof(yes);
                    };
                    ...
                    struct select_system6_exists
                    {
                        ...
                        static const bool value
                            = sizeof(check(select_system(tag1, tag2, tag3, tag4, tag5, tag6)))
                              == sizeof(yes);
                    };
            ...
            namespace generic
            {
                ...
                template <typename Tag1, typename Tag2>
                struct select_system2_exists
                    : generic_type_traits_ns::select_system_exists_ns::select_system2_exists<Tag1,
                                                                                             Tag2>
                {
                };

                template <typename Tag1, typename Tag2, typename Tag3>
                struct select_system3_exists : generic_type_traits_ns::select_system_exists_ns::
                                                   select_system3_exists<Tag1, Tag2, Tag3>
                {
                };

                template <typename Tag1, typename Tag2, typename Tag3, typename Tag4>
                struct select_system4_exists : generic_type_traits_ns::select_system_exists_ns::
                                                   select_system4_exists<Tag1, Tag2, Tag3, Tag4>
                {
                };
                ...
                struct select_system5_exists
                    : generic_type_traits_ns::select_system_exists_ns::
                          select_system5_exists<Tag1, Tag2, Tag3, Tag4, Tag5>
                {
                };
                ...
                struct select_system6_exists
                    : generic_type_traits_ns::select_system_exists_ns::
                          select_system6_exists<Tag1, Tag2, Tag3, Tag4, Tag5, Tag6>
                {
                };
