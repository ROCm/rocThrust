        ...
        namespace detail
        {
            namespace generic
            {
                namespace select_system_detail
                {
                    ...
                    __host__ __device__ System&
                                        min_system(thrust::execution_policy<System>& system1,
                    ...
                    __host__ __device__ typename thrust::detail::enable_if<
                        thrust::detail::is_same<
                            System1,
                            typename thrust::detail::minimum_system<System1, System2>::type>::value,
                        System1&>::type
                        min_system(thrust::execution_policy<System1>& system1,
                                   thrust::execution_policy<System2>&)
                    {
                        return thrust::detail::derived_cast(system1);
                    } // end min_system()
                    ...
                    __host__ __device__ typename thrust::detail::enable_if<
                        thrust::detail::is_same<
                            ...
                            typename thrust::detail::minimum_system<System1, System2>::type>::value,
                        System2&>::type
                        min_system(thrust::execution_policy<System1>&,
                ...
                template <typename System>
                __host__ __device__
                    typename thrust::detail::disable_if<select_system1_exists<System>::value,
                                                        System&>::type
                ...
                template <typename System1, typename System2>
                __host__ __device__ typename thrust::detail::enable_if_defined<
                    thrust::detail::minimum_system<System1, System2>>::type&
                ...
                __host__ __device__ typename thrust::detail::lazy_disable_if<
                ...
                template <typename System1,
                          ...
                          typename System6>
                __host__ __device__ typename thrust::detail::lazy_disable_if<
                    select_system6_exists<System1, System2, System3, System4, System5, System6>::
                        value,
                    thrust::detail::
                        minimum_system<System1, System2, System3, System4, System5, System6>>::type&
                    select_system(thrust::execution_policy<System1>& system1,
                                  thrust::execution_policy<System2>& system2,
                                  thrust::execution_policy<System3>& system3,
                                  thrust::execution_policy<System4>& system4,
                ...
                inline __host__ __device__ thrust::device_system_tag
                                           select_system(thrust::any_system_tag)
                {
