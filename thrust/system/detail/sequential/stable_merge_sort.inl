                   ...
                   StrictWeakOrdering comp)
{
  typedef typename thrust::iterator_value<RandomAccessIterator>::type value_type;
    ...
    THRUST_HIP_PRINTF("ERROR: Inplace Merge is not currently supported at device side because device malloc is not supported.\n");
    abort();
  #endif
                          ...
                          StrictWeakOrdering comp)
{
  ...
  #ifdef __HIP_DEVICE_COMPILE__
    THRUST_HIP_PRINTF("ERROR: Inplace Merge by Key is not currently supported at device side because device malloc is not supported.\n");
    abort();
  #endif
                                 ...
                                 StrictWeakOrdering comp)
{
  ...
  {
    #ifdef __HIP_DEVICE_COMPILE__
      THRUST_HIP_PRINTF("ERROR: Iterative Stable Merge Sort is not currently supported at device side because device malloc is not supported.\n");
      abort();
    #endif
                                        ...
                                        StrictWeakOrdering comp)
{
  ...
  {
    #ifdef __HIP_DEVICE_COMPILE__
      THRUST_HIP_PRINTF("ERROR: Iterative Stable Merge Sort by Key is not currently supported at device side because device malloc is not supported.\n");
      abort();
    #endif
