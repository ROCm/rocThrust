    ...
    namespace system
    {
        namespace detail
        {
            namespace sequential
            {
                ...
                __thrust_exec_check_disable__ template <typename ForwardIterator1,
                                                        typename ForwardIterator2>
                __host__ __device__ void iter_swap(ForwardIterator1 iter1, ForwardIterator2 iter2)
                {
                ...
                __host__ __device__ ForwardIterator
                                    partition(sequential::execution_policy<DerivedPolicy>&,
                ...
                __thrust_exec_check_disable__ template <typename DerivedPolicy,
                                                        ...
                                                        typename Predicate>
                __host__ __device__ ForwardIterator
                                    stable_partition(sequential::execution_policy<DerivedPolicy>& exec,
                                                     ForwardIterator                              first,
                                                     ForwardIterator                              last,
                                                     Predicate                                    pred)
                {
                                                     ...
                                                     Predicate                                    pred)
                {
                    ...
                    for(TempIterator iter = temp.begin(); iter != temp.end();
                        ++iter, ++stencil_iter)
                    {
