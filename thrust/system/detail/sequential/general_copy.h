            ...
            namespace sequential
            {
                namespace general_copy_detail
                {
                    ...
                    struct lazy_is_assignable
                        : thrust::detail::is_assignable<typename T1::type, typename T2::type>
                    {
                    };
                    ...
                    struct reference_is_assignable
                        : thrust::detail::eval_if<
                              ...
                              lazy_is_assignable<thrust::iterator_reference<OutputIterator>,
                                                 thrust::iterator_reference<InputIterator>>>::type
                    {
                    };
                    ...
                    __thrust_exec_check_disable__ template <typename OutputIterator,
                                                            typename InputIterator>
                    inline __host__ __device__ typename thrust::detail::enable_if<
                        reference_is_assignable<InputIterator, OutputIterator>::value>::type
                    ...
                    __thrust_exec_check_disable__ template <typename OutputIterator,
                                                            typename InputIterator>
                    inline __host__ __device__ typename thrust::detail::disable_if<
                        reference_is_assignable<InputIterator, OutputIterator>::value>::type
                        iter_assign(OutputIterator dst, InputIterator src)
                    {
                ...
                __thrust_exec_check_disable__ template <typename InputIterator,
                                                        typename OutputIterator>
                __host__ __device__ OutputIterator general_copy(InputIterator  first,
                                                                InputIterator  last,
                ...
                __thrust_exec_check_disable__ template <typename InputIterator,
                                                        typename Size,
                                                        typename OutputIterator>
                __host__ __device__ OutputIterator general_copy_n(InputIterator  first,
                                                                  Size           n,
                                                                  OutputIterator result)
                {
