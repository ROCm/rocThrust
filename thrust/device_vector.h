 ...
 */
   ...
   */
     ...
     */
        ...
        __host__ explicit __device__ device_vector(const device_vector<OtherT, OtherAlloc>& v)
            : Parent(v)
        {
        }
     ...
     */
        template <typename OtherT, typename OtherAlloc>
        __host__ device_vector& operator=(const device_vector<OtherT, OtherAlloc>& v)
        {
            Parent::operator=(v);
            return *this;
        }
