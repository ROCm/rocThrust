...
#define ASSERT_EQUAL_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_equal((X), (Y), FILE_, LINE_)
#define ASSERT_EQUAL_QUIET_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_equal_quiet((X), (Y), FILE_, LINE_)
#define ASSERT_NOT_EQUAL_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_not_equal((X), (Y), FILE_, LINE_)
#define ASSERT_NOT_EQUAL_QUIET_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_not_equal_quiet((X), (Y), FILE_, LINE_)
#define ASSERT_LEQUAL_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_lequal((X), (Y), FILE_, LINE_)
#define ASSERT_GEQUAL_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_gequal((X), (Y), FILE_, LINE_)
#define ASSERT_LESS_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_less((X), (Y), FILE_, LINE_)
#define ASSERT_GREATER_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_greater((X), (Y), FILE_, LINE_)
#define ASSERT_ALMOST_EQUAL_WITH_FILE_AND_LINE(X, Y, FILE_, LINE_) \
    unittest::assert_almost_equal((X), (Y), FILE_, LINE_)
...
#define ASSERT_THROWS_WITH_FILE_AND_LINE(EXPR, EXCEPTION_TYPE, FILE_, LINE_)                \
    {                                                                                       \
        ...
        unittest::check_assert_throws(                                                      \
            THRUST_PP_CAT2(__s, LINE_), THRUST_PP_STRINGIZE(EXCEPTION_TYPE), FILE_, LINE_); \
    }                                                                                       \
    /**/
...
#define ASSERT_NOT_EQUAL_QUIET(X, Y) \
    ASSERT_NOT_EQUAL_QUIET_WITH_FILE_AND_LINE((X), (Y), __FILE__, __LINE__)
...
#define ASSERT_ALMOST_EQUAL(X, Y) \
    ASSERT_ALMOST_EQUAL_WITH_FILE_AND_LINE((X), (Y), __FILE__, __LINE__)
#define ASSERT_EQUAL_RANGES(X, Y, Z) \
    ASSERT_EQUAL_WITH_FILE_AND_LINE((X), (Y), (Z), __FILE__, __LINE__)
...
namespace unittest
{
    ...
    // sometimes its not possible to << a type
    template <typename T1, typename T2>
    void assert_not_equal_quiet(const T1&          a,
                                const T2&          b,
                                const std::string& filename = "unknown",
                                int                lineno   = -1)
    {
    ...
    template <typename T1, typename T2>
    void assert_almost_equal(thrust::complex<T1> a,
                             thrust::complex<T2> b,
                             const std::string&  filename = "unknown",
                             int                 lineno   = -1,
                             double              a_tol    = DEFAULT_ABSOLUTE_TOL,
    ...
    void check_assert_throws(threw_status       s,
