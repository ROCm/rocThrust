...
template<class Params> class ScanByKeyTests : public ::testing::Test
{
public:
...
TYPED_TEST_CASE(ScanByKeyTests, TestParams);

template<class Params> class ScanByKeyVariablesTests : public ::testing::Test
{
public:
    using input_type = typename Params::input_type;
};
...
TYPED_TEST_CASE(ScanByKeyVariablesTests, TestVariableParams);

template<class Params> class ScanByKeyVectorTests : public ::testing::Test
{
public:
    using input_type = typename Params::input_type;
};
...
TYPED_TEST_CASE(ScanByKeyVectorTests, VectorParams);
...
TYPED_TEST(ScanByKeyVariablesTests, TestInclusiveScanByKey)
{
    ...
    for (auto size : sizes) {
        ...
        thrust::host_vector<int> h_vals = get_random_data<int>(size,
...
TYPED_TEST(ScanByKeyVariablesTests, TestInclusiveScanByKeyInPlace)
{
    ...
    for (auto size : sizes) {
        ...
        thrust::host_vector<T> h_vals = get_random_data<int>(size,
                                                             std::numeric_limits<int>::min(),
                                                             std::numeric_limits<int>::max());
        for(size_t i = 0; i < size; i++)
            h_vals[i] = i % 10;
...
TEST(ScanByKeyTests, TestScanByKeyMixedTypes)
{
    ...
    thrust::host_vector<unsigned int> h_vals = get_random_data<unsigned int>(size,
                                                                             std::numeric_limits<int>::min(),
                                                                             std::numeric_limits<int>::max());
    for(size_t i = 0; i < size; i++)
        h_vals[i] %= 10;
...
TEST(ScanByKeyTests, TestScanByKeyLargeInput)
{
    ...
    thrust::host_vector<int> vals_sizes = get_random_data<int>(10,
                                                               std::numeric_limits<int>::min(),
                                                               std::numeric_limits<int>::max());

    thrust::host_vector<int> h_vals = get_random_data<int>(N,
                                                           std::numeric_limits<int>::min(),
                                                           std::numeric_limits<int>::max());
    thrust::device_vector<unsigned int> d_vals = h_vals;
